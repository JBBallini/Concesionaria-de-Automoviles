...
public class EditarAuto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Editar Auto");
        ...
        btnGuardarCambios.setBackground(new java.awt.Color(207, 93, 27));
        btnGuardarCambios.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        btnGuardarCambios.setForeground(new java.awt.Color(0, 0, 0));
        btnGuardarCambios.setIcon(new javax.swing.ImageIcon("C:\\Users\\porokiin\\Documents\\NetBeansProjects\\automovil\\src\\main\\java\\igu\\imgs\\icon_save.png")); // NOI18N
    ...
    private void btnGuardarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarCambiosActionPerformed
        ...
        if (modelo.isEmpty() || marca.isEmpty() || motor.isEmpty() || color.isEmpty() || patente.isEmpty() || puertas.isEmpty()){
            ...
            control.editarAuto(auto, modelo, marca, motor, color, patente, Integer.parseInt(puertas));
            mostrarMensaje("Cambios Guardados con Exito", "info", "Guardado Exitoso");
        }
    ...
    //Limpar contenido de los campos
    ...
    //Cargar datos de la entidad en los campos
    private void cargarDatos(int idAuto) {
        
        this.auto = control.traerAuto(idAuto);
        //Asigno los campos del auto Seleccionado
